...
/* V2ApiService
 스케일링정책실행
 @param executeScalingPolicyRequest executeScalingPolicyRequest
 @return *ExecuteScalingPolicyResponse*/
func (a *V2ApiService) ExecuteScalingPolicy(executeScalingPolicyRequest *ExecuteScalingPolicyRequest) (*ExecuteScalingPolicyResponse, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  ExecuteScalingPolicyResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/executeScalingPolicy"
	...
	// body params
	localVarPostBody = executeScalingPolicyRequest
	v := reflect.ValueOf(localVarPostBody).Elem().FieldByName("UserData")
	if v.IsValid() && v.CanAddr() {
		ptr := v.Addr().Interface().(**string)
		if *ptr != nil {
...
/* V2ApiService
 스케쥴액션생성/수정
 @param putScheduledActionRequest putScheduledActionRequest
 @return *PutScheduledActionResponse*/
func (a *V2ApiService) PutScheduledAction(putScheduledActionRequest *PutScheduledActionRequest) (*PutScheduledActionResponse, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  PutScheduledActionResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/putScheduledAction"
	...
	// body params
	localVarPostBody = putScheduledActionRequest
	v := reflect.ValueOf(localVarPostBody).Elem().FieldByName("UserData")
	if v.IsValid() && v.CanAddr() {
		ptr := v.Addr().Interface().(**string)
		if *ptr != nil {
